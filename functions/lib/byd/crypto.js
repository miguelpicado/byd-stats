...
function prepareAesMatrix(input) {
 ...
 */
function decryptBlockAuth(ciphertext, roundStart = 9) {
    if (!bangcleTables)
 ...
 */
function encryptBlockAuth(plaintext) {
    if (!bangcleTables)
        throw new Error('Bangcle tables not loaded');
 ...
 */
function decryptCbc(ciphertext, iv) {
 ...
 */
function encryptCbc(plaintext, iv) {
