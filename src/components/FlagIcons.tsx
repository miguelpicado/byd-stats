interface FlagIconProps { className?: string }

export const GaliciaFlag = ({ className }: FlagIconProps) => (
...
export const CataloniaFlag = ({ className }: FlagIconProps) => (
    <svg viewBox="0 0 640 480" className={className} xmlns="http://www.w3.org/2000/svg">
...
export const BasqueFlag = ({ className }: FlagIconProps) => (
    <svg viewBox="0 0 640 480" className={className} xmlns="http://www.w3.org/2000/svg">
...
export const UKFlag = ({ className }: FlagIconProps) => (
    <svg viewBox="0 0 640 480" className={className} xmlns="http://www.w3.org/2000/svg">
...
export const PortugalFlag = ({ className }: FlagIconProps) => (
    <svg viewBox="0 0 640 480" className={className} xmlns="http://www.w3.org/2000/svg">
