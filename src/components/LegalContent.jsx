        ...
        return (
            <div className="prose prose-slate dark:prose-invert max-w-none">
                ...
                <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-4 mb-6 flex gap-3">
                    ...
                    <p className="text-sm text-blue-700 dark:text-blue-400" dangerouslySetInnerHTML={{ __html: t('legal.privacy.summary') }} />
                </div>
                ...
                <section className="space-y-3">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400" dangerouslySetInnerHTML={{ __html: t('legal.privacy.sections.collection.text') }} />
                </section>
                ...
                <section className="space-y-3">
                    ...
                    <ul className="list-disc pl-5 text-sm text-slate-600 dark:text-slate-400 space-y-1">
                        <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.sections.storage.local') }} />
                        <li dangerouslySetInnerHTML={{ __html: t('legal.privacy.sections.storage.cloud') }} />
                    </ul>
                </section>
