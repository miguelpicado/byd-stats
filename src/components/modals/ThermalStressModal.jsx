...
import { Activity, X, Info, Thermometer } from '../Icons.jsx';
import ModalPortal from '../common/ModalPortal';
import { BYD_RED } from '@core/constants';

const ThermalStressModal = ({ isOpen, onClose, onSave, initialValue = 1.0 }) => {
                            ...
                            <div className="grid grid-cols-1 gap-2">
                                {recommendations.map((rec) => (
                                    <button
                                        ...
                                        className={`flex items-center justify-between p-3 rounded-xl border transition-all ${Math.abs(value - rec.value) < 0.01
