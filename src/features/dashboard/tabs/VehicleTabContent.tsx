...
const VehicleTabContent: FC<OverviewContentProps> = ({
    summary,
    tripDist,
    smallChartHeight,
    overviewSpacing,
    ...
    return (
        <div className={`${overviewSpacing}`}>
            ...
            {/* Charts - Hidden for Vehicle Tab */}
            <div className={`grid gap-4 ${isCompact ? 'grid-cols-1 lg:grid-cols-2 !gap-3' : 'grid-cols-1 lg:grid-cols-2'}`} style={{ display: 'none' }}>
