        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col pt-[env(safe-area-inset-top,24px)]">
            ...
            <header className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 sticky top-0 z-10 transition-colors">
                <div className="max-w-4xl mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-bold text-slate-900 dark:text-white leading-tight">Documentación Legal</h1>
                            <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">BYD Stats Analyzer</p>
                        </div>
                    </div>
            ...
            <main className="flex-1 max-w-4xl w-full mx-auto p-4 sm:p-6 lg:p-8">
                ...
                <div className="mt-8 text-center text-slate-500 text-xs px-4">
                    <p>© 2026 BYD Stats Community. Proyecto de Código Abierto.</p>
                    <p className="mt-1">Esta página existe con fines de transparencia y cumplimiento de las políticas de Google Play.</p>
                </div>
            </main>
        </div>
    );
