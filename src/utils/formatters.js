 ...
 */
export const calculateScore = (efficiency, minEff, maxEff) => {
 ...
 * @param {Object} trip - Trip object with trip and electricity properties
 * @param {Array} allTrips - Array of all trips
 * @returns {number} Percentile (0-100)
 */
export const calculatePercentile = (trip, allTrips) => {
